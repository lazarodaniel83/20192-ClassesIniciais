public class TesteMusica{
    ...
    public void run(){
        ...
        Musica musica1 = new Musica("TITULO", artistas1, 120, "GENEROA", CampoHarmonico.DO,
                                    "GRAVADORA");
                                    
        Musica musica2 = new Musica("TITULO", artistas2, 120, "GENEROA", CampoHarmonico.DO,
                                    "GRAVADORA");
        ...
        System.out.println(CampoHarmonico.DO.getValor());
    }    
